...
public class HelpWindow extends UiPart<Stage> {
    ...
    private void populateCommandTable() {
        commandTable.getItems().addAll(
            ...
            new CommandSummary("bday", "Add a birthday to a person",
                    "bday INDEX b/BIRTHDAY"),
            new CommandSummary("delete | rm", "Deletes person(s) by index or name",
                    "delete 1 2 3 OR delete John Doe, Jane Smith"),
            new CommandSummary("edit", "Edits a person's details",
                    "edit INDEX [n/NAME] [p/PHONE] [e/EMAIL] [a/ADDRESS] [t/TAG]..."),
            new CommandSummary("find | f", "Finds persons by fields (OR across fields)",
