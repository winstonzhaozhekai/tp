...
public class FavouriteCommandParserTest {
    ...
    @Test
    public void parse_validIndexArgs_returnsFavouriteCommand() {
        assertParseSuccess(parser, "1", new FavouriteCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_validNameArgs_returnsFavouriteCommand() {
        String nameInput = "John Doe";
        assertParseSuccess(parser, nameInput, new FavouriteCommand(new Name(nameInput)));
    }
